    ...
    public class AverageFrames : IEnumerable<object[]>
    {
        private readonly List<object[]> _data = new List<object[]>
        {
            new object[]
            {
                new List<Frame>
                {
                    new Frame{ Number = 1, Rolls = new List<Roll>{ new Roll{Number = 1, Value = 2}, new Roll{Number = 2, Value = 3} }},
                    new Frame{ Number = 2, Rolls = new List<Roll>{ new Roll{Number = 1, Value = 5}, new Roll{Number = 2, Value = 4} }},
                    ...
                    new Frame{ Number = 10, Rolls = new List<Roll>{ new Roll{Number = 1, Value = 3}, new Roll{Number = 2, Value = 2}}, IsFinalFrame = true }
                }, 90}
        };
