...
{
    public class GoodFramesWithFinalBonusRoll : IEnumerable<object[]>
    {
        private readonly List<object[]> _data = new List<object[]>
        {
            new object[]
            {
                new List<Frame>
                {
                    ...
                    new Frame{ Number = 6, Rolls = new List<Roll>{ new Roll{Number = 1, Value = 4}, new Roll{Number = 2, Value = 6, IsSpare = true } }},
                    ...
                    new Frame{ Number = 10, Rolls = new List<Roll>{ new Roll{Number = 1, Value = 2 }, new Roll{Number = 2, Value = 8, IsSpare = true}, new Roll{Number = 3, Value = 10, IsStrike = true} }, IsFinalFrame = true }
                }, 151 }
        };
